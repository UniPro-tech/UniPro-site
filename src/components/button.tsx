  ...
  return (
    <>
      <button
        ...
        className={`bg-white text-black ${disabled && styles.linkDisabled} ${props.className} group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md px-6 font-medium`}
      >
