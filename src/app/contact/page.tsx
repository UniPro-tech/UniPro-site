        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="bg-white/80 backdrop-blur-xs rounded-2xl p-6 sm:p-8 shadow-xs hover:shadow-md transition-shadow duration-300 animate-fadeInUp">
            <div className="space-y-4 sm:space-y-6">
              ...
              >
                <span className="text-base sm:text-lg">@UniPro_digital</span>
                <svg
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="space-y-2 sm:space-y-3">
                  ...
                  <Button
                    ...
                    className="inline-flex items-center gap-2 bg-blue-500 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg hover:bg-blue-600 transition-colors text-sm sm:text-base"
                  >
                    <svg
