  ...
  return (
    <main className="flex min-h-screen w-full flex-col items-center text-gray-800 space-y-0">
      ...
      >
        ...
        <Link
          className="absolute bottom-0 left-0 z-10 w-full pb-8 pt-4 font-sansen text-white/80 hover:text-white transition-colors duration-300 group"
          href="#recent"
        >
          <div className="flex flex-col items-center justify-center space-y-2">
            <div className="w-[30px] h-[30px] relative animate-float">
              <Image
            ...
            <span className="tracking-[0.5em] uppercase text-sm">Scroll</span>
          </div>
        </Link>
      </section>
      <section
