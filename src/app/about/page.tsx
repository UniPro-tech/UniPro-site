...
const Home = () => {
  return (
    <main className="flex min-h-screen w-full flex-col items-center text-slate-800">
      {/* ヒーローセクション */}
      <section className="relative w-full min-h-[60vh] flex items-center justify-center bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
      ...
      {/* ミッション・ビジョンセクション */}
      <section className="w-full py-16 sm:py-24 bg-linear-to-br from-blue-50 via-white to-blue-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="inline-flex items-center space-x-3">
                ...
                <h3 className="text-lg sm:text-xl font-bold tracking-wide bg-linear-to-br from-blue-600 to-blue-500 bg-clip-text text-transparent">
                  Mission
                </h3>
              </div>
          ...
          <div className="mt-12 sm:mt-16 text-center">
            <div className="inline-block px-6 sm:px-8 py-3 sm:py-4 rounded-2xl bg-linear-to-br from-blue-500/5 to-blue-600/5 backdrop-blur-xs border border-blue-100">
      ...
      <section className="w-full py-16 sm:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="bg-slate-50 rounded-2xl p-6 sm:p-8 shadow-xs">
            <p className="text-base sm:text-lg leading-relaxed mb-6">
              「Uni」という言葉には「1つの」という意味が込められています。これには2つの想いが込められています：
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                <span className="shrink-0 w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center rounded-full bg-slate-200 text-slate-600 mr-3 mt-1 text-sm sm:text-base">
                  1
                </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            {activities.map((activity) => (
              <div
                key={activity.title}
                className="bg-white rounded-2xl p-6 sm:p-8 shadow-xs hover:shadow-md transition-all duration-300 border border-slate-100"
              >
