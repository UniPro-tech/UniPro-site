  ...
  return (
    <main className="flex min-h-screen w-full flex-col items-center text-slate-800">
      ...
      <section className="relative w-full min-h-[60vh] flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
        <div className="absolute inset-0 bg-grid-white/[0.03] bg-[size:3rem_3rem]" />
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-full max-w-5xl px-6 py-20 text-center text-white relative z-10">
            <h1 className="text-4xl md:text-6xl font-bold font-sansen mb-8 animate-slideUp">
              UniProject
            </h1>
            <p className="relative">
              <span className="block text-xl md:text-2xl font-medium text-white/90 max-w-3xl mx-auto leading-relaxed tracking-wide font-sansjp opacity-0 animate-fadeInUp animation-delay-300">
                デジタル創作を通じて、
              </span>
              <span className="block text-xl md:text-2xl font-medium text-white/90 max-w-3xl mx-auto leading-relaxed tracking-wide font-sansjp mt-2 md:mt-0 opacity-0 animate-fadeInUp animation-delay-500">
      ...
      {/* ミッション・ビジョンセクション */}
      <section className="w-full py-24 bg-gradient-to-br from-blue-50 via-white to-blue-50">
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* ミッション */}
            <div className="space-y-6">
              <div className="inline-flex items-center space-x-3">
                <span className="w-12 h-12 flex items-center justify-center rounded-xl bg-blue-500 shadow-md shadow-blue-100">
                  <svg
                ...
                <h3 className="text-xl font-bold tracking-wide bg-gradient-to-br from-blue-600 to-blue-500 bg-clip-text text-transparent">
                  Mission
                </h3>
              </div>
          ...
          <div className="mt-16 text-center">
            <div className="inline-block px-8 py-4 rounded-2xl bg-gradient-to-br from-blue-500/5 to-blue-600/5 backdrop-blur-sm border border-blue-100">
          ...
          <div className="bg-slate-50 rounded-2xl p-8 shadow-sm">
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full bg-slate-200 text-slate-600 mr-3 mt-1">
                  1
                </span>
                <p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {activities.map((activity, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-all duration-300 border border-slate-100"
              >
      ...
      <section className="w-full py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold mb-8 text-slate-800">活動場所</h2>
          ...
          >
            ...
            <span className="text-lg font-medium">Discordに参加する</span>
          </Button>
        </div>
      </section>
    </main>
